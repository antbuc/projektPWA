...
<html>
    <head>
        <meta charset="utf-8">
        <title>El Condidencial-Pocetna</title>
    ...
    <body>
        ...
        <nav class="navigacija">
            <ul>
                ...
                <li><a class="link5" href="./administracija.php">ADMINISTRACIJA</a></li>
            </ul>
        </nav>
            ...
            <div class="container europalink">                
                ...
                <div class="row center">
                    <div class="col-lg-4 col-sm-12">
                        <img src="./slikeProjekt/euro2024.jpeg" alt="EuropskoPrvenstvoSlika">
                        <p>Europsko prvenstvo 2024 - sve što trebate znati, kada i gdje igra Hrvatska, raspored, rezultati...</p>
                    </div>
                    <!-- <div class="col-lg-4 col-sm-12"> -->
                        <?php
                            ...
                            // $query2 = "DELETE * FROM vijesti";
                            $result = @mysqli_query($MySQL, $query2);
                            while($row = @mysqli_fetch_array($result)) {
                                if($row['kategorija_vijesti'] == "europa" && $row["arhiva_vijesti"] == "NE"){
                                    print '
                    ...
                    <!-- </div> -->
                    <!-- <div class="col-lg-4 col-sm-12">
                        <img src="./slikeProjekt/europe-palace-5414752_1280.jpg" alt="EuropskiParlament">
                        <p>U HDZ-u likuju, u Mostu razočarani - Dva bivša eurozastupnika najveći gubitnici izbora.</p>
                    </div>
                    <div class="col-lg-4 col-sm-12">
                        <img src="./slikeProjekt/macron.jpg" alt="Macron">
                        <p>Macron je sve skloniji podržati von der Leyen.</p>
                    </div> -->
                </div>
            </div>
            <br>
